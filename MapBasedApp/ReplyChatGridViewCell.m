...
@implementation ReplyChatGridViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    NSArray* views = [[NSBundle mainBundle] loadNibNamed:@"ReplyChatGridViewCell" owner:nil options:nil];
    ...
    bubble = (UIImageView*)[mainView viewWithTag:4];
    [self.contentView addSubview:profileImage_bg];
    [self.contentView addSubview:userImage];
    [self.contentView addSubview:bubble];
    
    messageText = (UILabel *)[mainView viewWithTag:5];
    timeId = (UILabel *) [mainView viewWithTag:3];
